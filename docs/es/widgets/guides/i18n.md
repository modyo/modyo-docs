...
Los Widgets del catalogo traen por defecto un validador de formularios llamado [VeeValidate](https://vee-validate.logaretm.com/v4/) y para poder localizar los mensajes de error que el validador nos muestra tenemos que hacer una pequeña modificación al archivo de configuración de **i18n.js**.
