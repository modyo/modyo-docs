...
2. En la barra superior, selecciona **insertar imagen** para abrir un modal donde podrás arrastrar o subir un archivo.


**En la sección dedicada para administrar archivos.**

1. En el menú lateral selecciona **Content**.
2. Haz click en **Gestor de archivos**.
3. Da click en el botón **+ Nuevo Asset**.
4. Arrastra el archivo o haz click en el recuadro de carga para abrir una ventana de búsqueda.
5. Agrega etiquetas al archivo si lo deseas.
6. Da click en **Upload** para confirmar.
...
1. Da click en el nombre de un archivo para abrir la interfaz de edición de propiedades.
2. Haz click en **Borrar**, debajo de la imagen.
