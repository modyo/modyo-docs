...
### Integración con SSO
Los sistemas de Single Sign-On (SSO) son fundamentales en la estrategia de integración de Modyo con los sistemas de negocio.
