...
Modyo te ofrece la funcionalidad de definir elementos de forma global y reutilizarlos en todos los sitios donde se utilice Liquid. Esto te permite compartir código entre diferentes sitios.
