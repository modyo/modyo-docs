...
| **submission.due_date**                        | Fecha de vencimiento de la submission. Se calcula a partir del disparador configurado en el flujo de originación: el inicio de la submission o la respuesta a una pregunta de tipo Fecha del flujo. Queda vacía si el flujo no tiene vencimiento configurado o si aún no existe la fecha de referencia. | ```Tue, 22 Feb 2025 12:00:00 UTC +00:00```                 |
