...
| **[entry.author](#usuario)**: Objeto del usuario autor de la entrada. | ```tag1, tag2``` |
...
| **[site.pwa_icon](#asset)**: Objeto de tipo Asset que contiene la información del icono PWA. |  |
