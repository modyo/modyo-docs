...
:::danger Peligro
Si borras la campaña, no se puede recuperar y no quedará registrada en el en el sistema.
:::
...
- **Tipo**: Elige si la campaña se enviará por correo o notificación.
- **Asunto**: Texto que aparecerá en la línea de asunto del mensaje que se enviará a los usuarios.
- **Responder a**: Dirección de correo electrónico a la cual las personas pueden responder **(solo para campañas enviadas por correo).**
- **Plantilla**: Lista de [plantillas](/es/platform/customers/messaging.html#plantillas) que se usarán para enviar un correo. Si no seleccionas alguna, Modyo enviará a una plantilla en blanco **(solo para campañas de correo).**
...
Esto abre el editor WYSIWYG con la plantilla que seleccionaste. Edita la plantilla y haz click en el botón **Guardar** para confirmar los cambios y abrir la vista de estado de envío para enviar la campaña.
...
En la parte superior de la pantalla, el ícono de **vista previa** te permite visualizar tu campaña antes de enviarla. Da click en el botón verde **Enviar** para mandar la campaña. 

El botón contextual te permite:
...
Una vez enviada una campaña, no puedes enviarla nuevamente. Si deseas enviar de nuevo la misma campaña, selecciona la opción de clonar. Esto  crea una una nueva campaña con los mismos datos de nombre, segmentos y contenido, mientras que la información estadística parte de cero.
...
En campañas enviadas por correo puedes encontrar las siguientes cifras:
<img src="/assets/img/platform/Campaign copy.png" style="border: 1px solid #EEE; margin-top: 40px">
...
Si enviaste la campaña por notificación encuentras estas cifras:
...
:::warning Atención
Si no has enviado aún una campaña, los valores de esa campaña aparecerán en cero.
:::
...
Si borras una campaña cuando está en proceso de envío, esto no significa que no llegará a los usuarios, sino que se detiene el proceso en el punto en que se encuentra.
:::
...
Para crear tu mensaje en forma de correo, necesitas una plantilla para en la cual añadir los contenidos que desees.

En la sección plantillas puedes hacer maquetas de correos para después enviarlas a los usuarios.

Al ingresar puedes encontrar todas las plantillas de correos creadas. Cada plantilla está ordenada por nombre y puedes ver la última vez que se modificó.

:::tip Tip
Si vas a reutilizar una plantilla, recuerda revisar detalladamente su contenido, para evitar errores temporales que puedan confundir el mensaje que quieres enviar a tus usuarios.
:::

Bajo cada nombre hay un botón de editar. Al hacer clic en él, accederás al editor donde creaste la plantilla.

A un costado del botón el menú desplegable ofrece las siguientes opciones:

- **Vista previa**: Muestra el modelo de plantilla de correo que se encuentra guardada.
- **Copiar**: Permite hacer una copia de la plantilla.
...
Para crear una plantilla, haz click en el botón **+ Nueva Plantilla**, en la parte superior de la página. En la vista de edición designa un nombre a la plantilla.
...
Para guardar la plantilla, haz clic en el botón **Guardar** ubicado en la parte superior de la página.

Para usar la plantilla en un correo, selecciona el nombre de la plantilla al elaborar la campaña.
...
Al final de cada nombre de usuario está un botón que te permite reinscribir al usuario a cualquier campaña del sitio.
