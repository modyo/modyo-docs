...
Para ejecutar los pasos de este tutorial debes tener creados los contenidos del tutorial de contenido de Dynamic Bank y tener conocimientos sobre HTML CSS JS y la plataforma Modyo.

## Paso 1: Crear un sitio en la Nube

Dentro de Channels generar un sitio en donde crearemos nuestro Home de Dynamic Bank, para esto necesitamos el theme Minimal

![Create site](/assets/img/tutorials/how-to-create-dynamicbank-home/new-site.png)

## Paso 2: Cambiar variables para darle look and feel de Dynamic Bank

Dentro de los Templates tenemos un snippet que se llama variables css en el cual están las variables que se utilizan en el resto de archivos de nuestro tema.

Para hacer el cambio vamos a modificar las variables de <b>colores</b>:
...
Y las variables de <b>botones</b>:
...
En los layout tenemos que sacar los container para poder utilizar el 100% del ancho de nuestra page.

<code>class="container"</code>

## Paso 4: Cambiar fuente del sitio

En el minimal estamos usando la librería webfontload para cargar nuestras tipografías asincronicas y no depender de la carga en el casi de Dynamic utilizaremos la fuente Jost y para cambiarla tenemos que entrar al snippet webfontload_config_js y cambiar la línea <b>families: ['DM Sans:400,700&display=swap']</b> por <b>families: ['Jost:400,700&display=swap']</b>.

## Paso 4: Cambiar header y footer

Hacer el HTML del header y footer.
...
Generar un snippet para el css del footer y agregarlo a la hoja de estilos base
...
## Paso 5: Cargar logo y favicon

Cargar el logo de Dynamic Bank y favicon en las setting del sitio

Logo
<img src="https://cloud.modyocdn.com/uploads/b3d572c9-a49a-4b8a-b411-d9b79b9b7b1d/original/dynamicbank-01.svg" style="margin: 30px 0;width: 300px;">

Favicon

<img src="https://cloud.modyocdn.com/uploads/c71040f5-192f-496d-a912-5bf40b4dd9e1/C32x32/dynamic-health-logo.ico" style="margin: 30px 0;width: 32px;">

## Paso 6: Hacer cambios de css de Bootstrap

Cambiar tamaño del logo<br>
<code>.navbar-brand img</code><br>

Cambiar active del menu<br>
<code>.navbar-light .navbar-nav .nav-link</code><br>
<code>.navbar-light .navbar-nav .show > .nav-link</code>

Cambiar active del menu<br>
<code>.navbar-light .navbar-nav .nav-link</code><br>
<code>.navbar-light .navbar-nav .show > .nav-link</code>

## Paso 8: Agregar librerías dependientes
...
## Paso 8: Crear Snippet css para Home y agregarla en la Hoja de CSS

Crear un snippet de css para agregar nuestro css para el Home

![Add snippet](/assets/img/tutorials/how-to-create-dynamicbank-home/snippet.png)

Agregarlo en nuestra hoja de css general con el siguiente código

<code>{% snippet "home_css" %}</code>

## Paso 9: Generar el menu

Para modificar el menu tenemos que ir a la pestaña de Navigation y generar los links que necesitemos

![Navigation](/assets/img/tutorials/how-to-create-dynamicbank-home/navigation.png)

## Paso 10: Modificar Page Home

Luego de tener armada la base de nuestro sitio, podemos empezar a armar la estructura de nuestro Home.

![Pages](/assets/img/tutorials/how-to-create-dynamicbank-home/page.png)

Para esto vamos a ir al menú Pages y abrir el Home

![Home](/assets/img/tutorials/how-to-create-dynamicbank-home/home.png)

Agregar Content featured al Home

![Content featured](/assets/img/tutorials/how-to-create-dynamicbank-home/content_featured.png)

Y agregar los parámetros de nuestro space ya creado

![Params Content featured](/assets/img/tutorials/how-to-create-dynamicbank-home/params_content.png)

Luego hacemos el html en Templates - Snippets - Widgets - content featured widget
...
y nuestro css en el Snippet <code>home_css</code>
...
Y previsualizamos teniendo en draft page y template

![Pages](/assets/img/tutorials/how-to-create-dynamicbank-home/preview.png)

## Paso 11: widgets de News

Para nuestro piso de noticias vamos a realizar un widget de HTML el cual conectaremos con nuestros contenidos con el SDK de liquid. Esto se realiza con un assign de liquid refiriendo al space type.

<code>{% assign entries = spaces['bank'].types['news'].entries | paginated: 3 %}</code>
...
## Paso 12: Widgets de Beneficios

Para generar nuestro Widget de Beneficios lo realizaremos de la misma forma pero llamando a otro Type en este casi benefits.

<code>{% assign entries = spaces['bank'].types['benefits'].entries | paginated: 7 %}</code>
...
## Paso 13: Widgets de DYNAMIC APP
...
## Paso 14: Widgets de Testimonios

El widget de testimonios es un poco más complejo ya que tiene Javascript para generar el slide, es por esto que tenemos que generar un widget dentro del widget builder en el panel widgets dentro del sitio

![Widgets](/assets/img/tutorials/how-to-create-dynamicbank-home/widgets.png)
...
Una vez terminado el widget, revisado en el preview, tenemos que publicarlo para tenerlo disponible en nuestra biblioteca de widgets y así poder utilizarno en nuestra page Home.
...
![Widgets](/assets/img/tutorials/how-to-create-dynamicbank-home/cursom_widget.png)

y de este modo tendremos nuestros widgets ya en el Home:

![Widgets home](/assets/img/tutorials/how-to-create-dynamicbank-home/widgets_home.png)
