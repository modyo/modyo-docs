...
OpenID Connect (OIDC) es una capa de autenticación y framework que funiona sobre OAuth 2.0. Su estandar está controlado por la [https://openid.net/connect/](OpenID Foundation).
