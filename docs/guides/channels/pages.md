...
Las páginas son lo que te permite crear una estructura para tu sitio, donde puedes añadir contenido no estructurado y personalizar las rutas de donde se muestra ese contenido. 
...
:::
- **Contenido**: Son widgets por defecto que te permitirá mostrar listados de contenido haciendo uso de filtros por espacio, tipo, idioma, tags y categoría. Para modificar como se ven estos widgets, deberás hacerlo en el template builder, en la sección widgets.
