...
<iframe id="widgetFrameAccountES" src="https://widgets-es.modyo.com/inversiones/cuentas" width="100%" frameBorder="0"  style="visibility:hidden;overflow:auto;margin-top:20px;"/>
    ...
    mounted() {
      ...
      function handleDocHeightMsg(e) {
          ...
          if ( e.origin === 'https://widgets-es.modyo.com' ) {
              ...
              // check data object
              if ( data['docHeight'] ) {
                  setIframeHeightCO( 'widgetFrameAccountES', data['docHeight'] );
              } else {
                  setIframeHeightCO( 'widgetFrameAccountES', 700 );
              }
          }
      }
