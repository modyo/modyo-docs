    ...
    <div class="banner">
      <div class="banner-content">
        <div class="banner-text">
          <strong>Modyo 9.2:</strong> You are viewing an older version of the Modyo documentation. For a more recent version please visit <a href="https://docs.modyo.com">https://docs.modyo.com</a>.
        </div>
      </div>
    </div>
