<template>
  <main id="test-deployment-01" class="home" aria-labelledby="main-title">
    <div class=" m-0 p-0">
      ...
      <div class="first_steps container">
        <div class="mb-5">
          <h3 class="m-0 mb-2 text-center">{{data.FirstStepsTitle}} <span class="text-primary">Modyo</span>
          </h3>
          <h5 class="text-muted m-0 text-center">{{data.FirstStepsText}}</h5>
        </div>
        ...
        <div class="row align-items-center my-5 pt-5 pb-md-5">
          <div class="col-12 col-md-6">
            <img
              ...
              alt="digital products with micro frontends">
          </div>
          <div class="col-12 col-md-6">
            <div class="m-0 m-md-3">
      ...
      <div class="container mb-5 py-5">
        <div class="row no-gutters bg-dark">
          <div class="col-12 col-md-6"
            style="background-image: url(https://cloud.modyocdn.com/uploads/52aefd55-ba90-4542-92d5-08a57bf97f80/original/img_bcibank.jpg);background-size: cover;background-repeat: no-repeat;">
          </div>
          <div class="col-12 col-md-6">
            <div class="m-4 p-3 p-md-5">
              <h3 class="m-0 mb-1 w-100 text-white" style="font-size: 2.5rem;line-height: 1.1;">{{data.DontMiss}}
                <span class="text-primary">Modyo</span></h3>
              <h5 class="text-muted mt-0 mb-4">{{data.DontMissText}}</h5>
              <div class="a_arrow">
                <a :href="data.releaseUrl" class="text-white">{{data.releaseText}} <img
                    src="https://cloud.modyocdn.com/uploads/320ed6bc-5f00-4203-af7f-7ba55f2294c1/original/mdi_arrow_right_alt.png"></a>
                <a :href="data.roadmapUrl" target="_blank" class="text-white">{{data.roadmapText}} <img
                    src="https://cloud.modyocdn.com/uploads/320ed6bc-5f00-4203-af7f-7ba55f2294c1/original/mdi_arrow_right_alt.png"></a>
              </div>
            </div>
          </div>
      ...
      <div class="bg-dark py-5 more-help  bg-ornamental">
...
.shadow {
  box-shadow: 0 0 5rem rgba(21, 31, 56, 0.1)!important;
  transition:.3s;
}
a.shadow:hover {
  transition:.3s;
...
.search .search-box input {
  ...
  background-image: url(https://cloud.modyocdn.com/uploads/b2293ffa-8090-4e48-bb75-bf484719b3a8/original/search.png);
...
.btn-primary {
    color: rgba(255, 255, 255, 1);
    background-color: rgba(61, 198, 129, 1);
    border-color: rgba(61, 198, 129, 1);
}
.btn-primary:hover {
    color: rgba(255, 255, 255, 1);
    background-color: rgba(113, 213, 163, 1);
    border-color: rgba(113, 213, 163, 1);
}
.btn-outline-primary {
