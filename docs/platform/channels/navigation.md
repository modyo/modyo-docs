...
- **Aprobado**: Este estado aparece cuando esté habilitada la [Revisión en Equipo](platform/platform/team-review.html) y si es que se cumplieron las condiciones de revisión del elemento. Si se encuentra en este estado, tus templates ya pueden ser publicados.
