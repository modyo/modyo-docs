...
- **En revisión**: Cuando se habilita la [revisión en equipo](/platform/core/key-concepts.html) y se ha enviado a revisión la versión editable.
- **Aprobado**: Cuando se habilita la [revisión en equipo](/platform/core/key-concepts.html) y si es que se cumplieron las condiciones de revisión del elemento. Si estás en este estado, tus templates están listos para ser publicados.
...
Para más información sobre el versionamiento, échale un vistazo a la sección de [versionado](/platform/core/key-concepts.html#versionado).
:::
