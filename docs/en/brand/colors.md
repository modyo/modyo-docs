...
Our secondary colors and that usually accompany the brand on different supports, are blue.They should be used sparingly throughout the illustration, photography, and product to maintain meaning and potency.
...
Our brand is well accompanied by the following colors:
...
<li> As a background of illustrations (only in the case of light blue)</li>
</ul>
...
All background colors are defined with the colors in the main palette and special colors with the following usage rule: <b>Apply 6% to 12% Opacity</b>
...
<tr>
<td>
<p class="dont">Do not use special colors, leaving out completely the brand identity.</p>
</td>
<td>
<p class="dont">Text should never have a color other than the primary colors, especially the paragraph.</p>
</td>
<td>
<p class="dont">Do not use special background colors, losing even contrast.</p>
</td>
</tr>
<tr>
<td>
...
<tr>
<td>
<p class="dont">Do not use a special or different color to the one mentioned above for an overlay.</p>
</td>
<td>
<p class="dont">Do not use a special or different color to the one mentioned above for an overlay.</p>
</td>
