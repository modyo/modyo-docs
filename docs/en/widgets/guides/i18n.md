...
Catalog Widgets have by default a form validator called [VeeValidate](https://vee-validate.logaretm.com/v4/) and in order to locate the error messages that the validator shows us we have to make a small modification to the **i18n** configuration file.
