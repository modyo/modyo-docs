...
<iframe id="widgetFrameDSEN" src="https://widgets.modyo.com/inversiones/resumen-detallado" width="100%" frameBorder="0" style="visibility:hidden;overflow:auto;margin-top:20px;"/>
    ...
    mounted() {
      ...
      function handleDocHeightMsg(e) {
          ...
          if ( e.origin === 'https://widgets.modyo.com' ) {
              ...
              // check data object
              if ( data['docHeight'] ) {
                  setIframeHeightCO( 'widgetFrameDSEN', data['docHeight'] );
              } else {
