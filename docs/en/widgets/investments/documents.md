...
| Electronic Contract Signatures     | Allows you to see which contracts must be signed, either because they are new or because there are new or updated versions of contracts. It allows you to review the on-screen contracts and proceed to sign them directly with the internet key. |
