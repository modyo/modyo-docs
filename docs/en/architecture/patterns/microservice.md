...
- **Heavy tasks: ** We recommend using background processing, using [messaging queues] (/es/connect/components/infrastructure.html #colas -de-messaging), for services that are slow or sensitive to traffic fluctuations.
