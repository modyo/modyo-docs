...
On the other hand, snippets are a very convenient way to organize source codes using [snippets](/es
n/platform/channels/templates.md#snippets), which can be referenced from different Liquid templates on the same site. 
