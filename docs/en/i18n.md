...
:::tip Nota Para saber mas sobre internacionalización y vue-i18n les recomiendo revisar este curso gratuito [Internationalization with vue-i18n](https://vueschool.io/courses/internationalization-with-vue-i18n) de [VueSchool](https://vueschool.io/) :::
