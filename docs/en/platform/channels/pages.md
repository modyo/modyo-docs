...
3. Click on **Pages**.
4. Click on **+ New Page**.
5. Fill in the Layout Name, Path, if necessary select the parent layout, and press **Create**.
6. Customize the page by adding or editing widgets.
7. Once finished, click on **Publish**.

For the types of widgets you can add, see [Widgets](/en/platform/channels/pages.html#widgets)
