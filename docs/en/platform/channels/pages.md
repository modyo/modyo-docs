...
::: tip Tip
If your page is in "draft" status, the differences icon will not appear, since there is nothing to compare the current editable version. To learn more about the differences and support, review the [versioning](/en/platform/platform/team-review.html # versioning) section. 
:::
