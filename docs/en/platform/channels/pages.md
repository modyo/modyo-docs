...
- Add widget: Add Widgets: allows you to select widgets from a list and add them to the grid.
- Edit widget: Edit Widget: allows you to change different properties and filters for each widget.
