...
| Description  | Example  |
|---|---|
| ** [space.categories] (#categoria) ** An array of objects of the category type that contains all the categories of space. |  |
| ** [space.entries] (#entrada) ** Page-type object that meets the search parameters.  | |
| ** [space.types] (#tipo -content) ** Content-type object array that contains all the types of space.  | |
...
| Description  | Example  |
|---|---|
| **widget.cache_key** The cache key associated with the widget.  | ```widgets/content_list_widgets/506-202202151403000000``` |
