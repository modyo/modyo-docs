...
Generate the URL of a barcode. *e.g.*
...
Translate a date to another format. *e.g.*
...
Sanitize the HTML tags in a String. *e.g.*
...
Convert a date in String to words. *e.g.*
...
Return a list of all the widgets that belong to a “me” page. *e.g.*
<span v-pre>`{{site | resolve_me_widget_list}}`</span>

### Resolve Widget List

Return a list of all the widgets that belong to a page. *e.g.*
