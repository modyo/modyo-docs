...
- **Approved**: You will see this status when [team review](/en/platform/core/key-concepts.html) is enabled and if the item review conditions were met. If you are in this state, your changes are ready to be published.
