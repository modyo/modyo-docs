...
If you check the box to forward an email to the user considering it inactive, the user will receive an email notification. From this email, you will be able to reactivate your account.
