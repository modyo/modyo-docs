...
The current documentation applies to the latest version (Modyo 10). If you need information about previous versions (Modyo 9.2), [you can access it here](https://9-2.docs.modyo.com/en/).
