...
- **Tags**: Tags to identify the user.
...
Some special fields, such as second surname, avatar or date of birth, can be activated in the [Registration Form](/en/platform/customers/realms.html #formulario -de-registration) section. You can also create and modify custom fields in the [Custom Fields](/en/platform/customers/realms.html #custom -fields) section.
...
You must have the correct configuration of the associated service so that Modyo can connect to it. Make sure you complete all the required fields. For more information on integrations, see the [Identity Providers] (/en/platform/core/integrations/identity-providers.html) section.
