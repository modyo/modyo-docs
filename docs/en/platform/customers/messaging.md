...
When you click on the user's name, you can see the [user's profile] (/es/platform/customers/realms.html #ficha -users) and all the activities they have performed on the platform.
