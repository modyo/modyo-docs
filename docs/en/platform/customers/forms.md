...
::: warning Warning
If you use a Modyo site with a custom domain, you must enable the option to share resource sources [CORS](/en/platform/core/security.htm) in the account settings.
:::
