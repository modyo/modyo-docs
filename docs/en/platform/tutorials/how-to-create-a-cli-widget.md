...
Welcome to a new tutorial in the Modyo training series. This tutorial focuses on creating a [Widget](/en/platform/channels/widgets.html), where you can use [Dynamic Framework](/en/dynamic/) using the [Modyo CLI](/en/platform/channels/widgets.html#modyo-cli).
