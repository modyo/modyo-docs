...
The official typography of Modyo for use in all its formats and platforms is [DM Sans](https://fonts.google.com/specimen/DM+Sans).
...
<table class="no-border">
 ...
 <tr style="background: #F6F7F7;">
  <td style="width: 50%;padding: 24px 34px;">
   <span style="font-weight: regular;font-size: 18px;">Paragrapho</span>
  </td>
  <td style="width: 50%;padding: 24px 34px;">
   Regular 16px/27.2px
  </td>
